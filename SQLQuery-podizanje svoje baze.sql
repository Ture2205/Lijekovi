...
ALTER DATABASE db_aa59a3_mario SET SINGLE_USER WITH
ROLLBACK IMMEDIATE;
GO
ALTER DATABASE db_aa59a3_mario COLLATE Croatian_CI_AS;
GO
ALTER DATABASE db_aa59a3_mario SET MULTI_USER;
GO
SELECT name, collation_name FROM sys.databases;
GO
